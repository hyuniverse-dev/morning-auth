...
class ReqWatcherDTO(
    ...
    @Schema(
        description = "접근권한",
        nullable = false,
        example = "48fbf86a7a2211eeb1d10242ac130002"
    )
    ...
    @Schema(description = "이메일", nullable = false, example = "watcher@mncf.io")
    ...
    @JsonIgnore
    var watcherDetail = ReqWatcherDetailDTO(this.managerCode, this.registerCode, this.modifierCode)
